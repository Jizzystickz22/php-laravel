<?php /* Smarty version Smarty-3.1.21, created on 2019-04-15 16:10:23
         compiled from "C:\laragon\www\multivendor\design\backend\templates\views\index\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7898278465cb482bfe4d6d0-47163008%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3292694e426fef2818841236ab257b12daa56e90' => 
    array (
      0 => 'C:\\laragon\\www\\multivendor\\design\\backend\\templates\\views\\index\\index.tpl',
      1 => 1550487342,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '7898278465cb482bfe4d6d0-47163008',
  'function' => 
  array (
    'get_orders' => 
    array (
  ...
  'unifunc' => 'content_5cb482c08914e2_95995965',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cb482c08914e2_95995965')) {function content_5cb482c08914e2_95995965($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/laragon/www/multivendor/app/functions/smarty_plugins\\function.script.php';
...
if (!is_callable('smarty_modifier_count')) include 'C:/laragon/www/multivendor/app/functions/smarty_plugins\\modifier.count.php';
if (!is_callable('smarty_modifier_enum')) include 'C:/laragon/www/multivendor/app/functions/smarty_plugins\\modifier.enum.php';
?><?php
...
$_tmp6=ob_get_clean();?><?php echo htmlspecialchars(fn_url("products.manage?amount_from=&amount_to=0&tracking[0]=".$_tmp5."&tracking[1]=".$_tmp6), ENT_QUOTES, 'UTF-8');?>
...
"><?php echo htmlspecialchars(number_format($_smarty_tpl->tpl_vars['general_stats']->value['pages']['total_pages']), ENT_QUOTES, 'UTF-8');?>
    ...
    <?php if (!is_callable('smarty_modifier_date_format')) include 'C:/laragon/www/multivendor/app/functions/smarty_plugins\modifier.date_format.php';
...
"><?php echo $_smarty_tpl->__('show_all');?>
                    ...
                    <?php if (!is_callable('smarty_block_hook')) include 'C:/laragon/www/multivendor/app/functions/smarty_plugins\block.hook.php';
if (!is_callable('smarty_modifier_date_format')) include 'C:/laragon/www/multivendor/app/functions/smarty_plugins\modifier.date_format.php';
...
$_tmp7=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['link_storefront'] = new Smarty_variable($_tmp7, null, 0);?>
        <?php }?>
