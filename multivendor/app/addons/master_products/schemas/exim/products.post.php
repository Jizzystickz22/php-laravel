...
if (fn_allowed_for('MULTIVENDOR')) {
    ...
    // remove unnecessary fields from vendor products when importing them
    $schema['import_process_data']['master_products_exim_unset_vendor_products_fields'] = [
        'function'    => 'fn_master_products_exim_unset_vendor_products_fields',
        'args'        => ['$pattern', '$primary_object_id', '$object', '$skip_record'],
        'import_only' => true,
    ];
