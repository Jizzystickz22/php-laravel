...
// Initialize Firebase
var config = {
    apiKey: "{{ config('services.firebase.AIzaSyA8sWt__tbcPGFNYu6gPCeHWBKCIx8cqqQ') }}",
    authDomain: "{{ config('services.firebase.vendors-signin.firebaseapp.com') }}",
    databaseURL: "{{ config('services.firebase.https://vendors-signin.firebaseio.com/') }}",
    storageBucket: "{{ config('services.firebase.vendors-signin.appspot.com') }}",

};
firebase.initializeApp(config);

var database = firebase.database('vendors signin/users');

var lastIndex = 0;

// Get Data
firebase.database().ref('vendors signin/users').on('value', function(snapshot) {
...
$('#submitUser').on('click', function(){
    ...
    firebase.database().ref('vendors signin/users' + userID).set({
...
$('body').on('click', '.updateData', function() {
	...
	firebase.database().ref('vendors signin/users' + updateID).on('value', function(snapshot) {
...
$('.updateUserRecord').on('click', function() {
	...
	firebase.database().ref('vendors signin/users').update(updates);
...
$('.deleteMatchRecord').on('click', function(){
	...
	firebase.database().ref('vendors signin/users' + id).remove();
